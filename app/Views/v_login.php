...
<body class="login">
   ...
   <center>
   <img src="<?= base_url('logo') ?>/logo.png" width="80px" height="80px" >
   </center>
   <div class="text-center">
  <a href="<?= base_url('Home')?>" style="font-size: 20px; font-weight:bold;">DESA CIGUGUR</a>
  </div>
   ...
   <?php echo form_close()?>
	...
	<script src="<?= base_url('back_end') ?>/assets/js/ready.js"></script>
</body>
</html>