...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2024 at 10:05 AM
...
CREATE TABLE `tbl_desa` (
  ...
  `logo_desa` int(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_penduduk` (
  ...
  `jk` int(5) DEFAULT NULL,
  `id_pendidikan` int(5) DEFAULT NULL,
  `id_penghasilan` int(5) DEFAULT NULL,
  `hub_keluarga` int(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Wiroh Widriana', 'admin', '8cb2237d0679ca88db6464eac60da96345513964', 1, 'admin.jpeg');
...
--
ALTER TABLE `tbl_penghasilan`
  MODIFY `id_penghasilan` int(5) NOT NULL AUTO_INCREMENT;
